...
export const projectsData = [
  ...
  },
  {
    ...
    description:
      "A backend focused project built using Node.js, Express, and MongoDB, using the CRUD operations and optimized UI rendering with EJS templates.",
